...
@SpringBootTest
public class Mead_Comms_Home_PageStepDefinitions {

  private static final Logger LOGGER = LoggerFactory.getLogger(Mead_Comms_Home_PageStepDefinitions.class);
  private static Map<Integer, ScenarioContext> contextMap = new HashMap<>();
  @LazyAutowired
  private Mead_Comms_Home_PageActions pageActions;
  @LazyAutowired
  ...
  public void navigate_to_RadioSearchpage() throws InterruptedException {
    pageActions.navigate_radio_page();
  ...
  public void check_title_of_radiosearchpage(String expt_title) throws InterruptedException {
    String act_title = pageActions.Radio_searchpage_title();
    Assertions.assertEquals(expt_title, act_title);
